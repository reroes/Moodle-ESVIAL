 ...
 * @return string
 */
function esvial_formal_white_user_settings($css, $theme) {
    ...
    $css = esvial_formal_white_set_fontsizereference($css, $fontsizereference);
    ...
    $css = esvial_formal_white_set_framemargin($css, $framemargin);
    ...
    $css = esvial_formal_white_set_headerbgc($css, $headerbgc);
    ...
    $css = esvial_formal_white_set_blockcontentbgc($css, $blockcontentbgc);
    ...
    $css = esvial_formal_white_set_lblockcolumnbgc($css, $lblockcolumnbgc);
    ...
    $css = esvial_formal_white_set_rblockcolumnbgc($css, $rblockcolumnbgc);
    ...
    $css = esvial_formal_white_set_blockcolumnwidth($css, $blockcolumnwidth);
    ...
    $css = esvial_formal_white_set_blockpadding($css, $blockcolumnwidth, $blockpadding);
    ...
    $css = esvial_formal_white_set_customcss($css, $customcss);
 ...
 *
 */
function esvial_formal_white_set_fontsizereference($css, $fontsizereference) {
    $tag = '[[setting:fontsizereference]]';
    $css = str_replace($tag, $fontsizereference.'px', $css);
    return $css;
}

function esvial_formal_white_set_framemargin($css, $framemargin) {
...
function esvial_formal_white_set_headerbgc($css, $headerbgc) {
    $tag = '[[setting:headerbgc]]';
    $css = str_replace($tag, $headerbgc, $css);
    return $css;
}

function esvial_formal_white_set_blockcontentbgc($css, $blockcontentbgc) {
    $tag = '[[setting:blockcontentbgc]]';
    $css = str_replace($tag, $blockcontentbgc, $css);
    return $css;
}

function esvial_formal_white_set_lblockcolumnbgc($css, $lblockcolumnbgc) {
    $tag = '[[setting:lblockcolumnbgc]]';
    $css = str_replace($tag, $lblockcolumnbgc, $css);
    return $css;
}

function esvial_formal_white_set_rblockcolumnbgc($css, $rblockcolumnbgc) {
    $tag = '[[setting:rblockcolumnbgc]]';
    $css = str_replace($tag, $rblockcolumnbgc, $css);
    return $css;
}

function esvial_formal_white_set_blockcolumnwidth($css, $blockcolumnwidth) {
...
function esvial_formal_white_set_blockpadding($css, $blockcolumnwidth, $blockpadding) {
...
function esvial_formal_white_set_customcss($css, $customcss) {
