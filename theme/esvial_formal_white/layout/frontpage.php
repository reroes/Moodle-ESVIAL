...
$index = '<a class="skip" accesskey="1" rel="Página Principal" name="Página Principal" href="'.$CFG->wwwroot.'">Ir a la página principal</a>';
...
$calendar = '<a class="skip" accesskey="5" rel="Calendario" name="Calendario" href="'.$CFG->wwwroot.'/calendar/">Ir al calendario</a>';
