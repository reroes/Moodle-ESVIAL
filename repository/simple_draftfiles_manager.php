...
$PAGE->set_url('/repository/simple_draftfiles_manager.php', $params);
$filepicker_url = new moodle_url($CFG->httpswwwroot."/repository/simple_filepicker.php", $params);
...
default:
    ...
    $filepicker_url->param('action', 'list');
    $filepicker_url->param('repo_id','3');
