...
/**
 * Strings for component 'theme_esvial_formal_white', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_esvial_formal_white
...
<div class="clearfix">
    <div class="theme_screenshot">
        <h2>ESVIAL Formal White</h2>
        <img src="esvial_formal_white/pix/screenshot.gif" />
    ...
    <div class="theme_description">
        <h2>About</h2>
        <p>ESVIAL Formal White is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
        <h2>Tweaks</h2>
...
$string['configtitle'] = 'ESVIAL Formal White Theme';
...
$string['noframe'] = 'ESVIAL Formal white 1.0 look';
...
$string['pluginname'] = 'ESVIAL Formal White';
