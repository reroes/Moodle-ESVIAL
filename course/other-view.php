...
//  Display the course home page.
    ...
    $PAGE->set_url('/course/other-view.php', $urlparams); // Defined here to avoid notices on errors etc
    ...
    add_to_log($course->id, 'course', $loglabel, "other-view.php?". $logparam, $infoid);
    ...
    if (include_course_ajax($course, $modnamesused)) {
        ...
        echo $renderer->course_modchooser2(get_module_metadata($course, $modnames, $displaysection), $course, $displaysection);
    }
